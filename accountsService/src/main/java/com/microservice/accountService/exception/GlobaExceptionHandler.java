package com.microservice.accountService.exception;
...
public class GlobaExceptionHandler extends ResponseEntityExceptionHandler{
	...
	public ResponseEntity<ErrorResponseDto> handlerForGlobalException(Exception exception
	...
	public ResponseEntity<ErrorResponseDto> customerIsAlreadyExsistExceptionHandler(CustomerIsAlreadyExistsException exception
			, WebRequest webRequest){
